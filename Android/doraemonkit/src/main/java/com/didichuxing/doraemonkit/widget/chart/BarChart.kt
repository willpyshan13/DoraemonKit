...
class BarChart : LinearLayout {
    private lateinit var markFirst: TextView
    private lateinit var markSecond: TextView
    private lateinit var markThird: TextView
    private lateinit var getValue: View
    private lateinit var postValue: View
    private lateinit var lineEnd: View
